package mk.finki.labs.eimtlab.articlemanagement.domain.event;
...
@Getter
public class CommentPosted implements DomainEvent {
    ...
    public CommentPosted(CommentId commentId, AuthorId articleAuthor, AuthorId postedById, String postedByName, ArticleId articleId, String articleTitle, Date postedOn, String activity, Instant occurredOn) {
